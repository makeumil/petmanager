// import { NAVER_CLIENT_ID, NAVER_REDIRECT_URI } from "../Properties";

// const NaverLogin = () => {
//         const STATE = "false";
//         const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?client_id=${NAVER_CLIENT_ID}&state=${STATE}&redirect_uri=${NAVER_REDIRECT_URI}&response_type=code`;
